...
def generate_cumulative_scores(firms, top_scores):
    cumulative_scores = {} # a dictionary of interview + resume scores for all the qualified applicants for all the firms
    for firm in firms:
        firm_cumulative_scores = {} # a dictionary of interview + resume scores for just one firm
...
# sorts the dictionary of interview + resume scores
